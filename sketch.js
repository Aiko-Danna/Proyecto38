...
function draw() {
  ...
  mainCyclist.x= camera.position.x -600;
...
function pinkCyclists(){
        player1 =createSprite(camera.position.x+700,Math.round(random(50, 250)));
        player1.scale =0.06;
...
function yellowCyclists(){
        player2 =createSprite(camera.position.x+700,Math.round(random(50, 250)));
        player2.scale =0.06;
...
function redCyclists(){
        player3 =createSprite(camera.position.x+700,Math.round(random(50, 250)));
        player3.scale =0.06;
